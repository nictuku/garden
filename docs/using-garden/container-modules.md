...
Here, for example, is the spec for the `frontend` service in our example [demo project](https://github.com/garden-io/garden/tree/v0.10.6/examples/demo-project):
...
Also check out the [Kubernetes Secrets example project](https://github.com/garden-io/garden/tree/v0.10.6/examples/kubernetes-secrets) for a working example.
