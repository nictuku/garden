...
_Note: The source code for this project can be found at: [https://github.com/garden-io/garden/tree/v0.10.6/examples/local-tls](https://github.com/garden-io/garden/tree/v0.10.6/examples/local-tls)._
